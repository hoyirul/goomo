  ...
  <div class="col-md-9 mb-3">
    <div class="card w-100 border-0 rad-10">
      <div class="card-body m-3">
        ...
        <form action="{{ url('/v2/address/'.$tables->id) }}" method="post">
          @csrf
          @method('PUT')
          ...
          <div class="mb-3 row">
            <div class="col-md-6">
              ...
              <input type="province" name="province" class="form-control rad-6 fs-normal" value="{{ $tables->province }}" placeholder="Province">
              @error('province')
            ...
            <div class="col-md-6">
              ...
              <input type="text" name="city" class="form-control rad-6 fs-normal" value="{{ $tables->city }}" placeholder="City">
              @error('city')
                <div class="invalid-feedback ml-1">{{ $message }}</div>
              @enderror
            </div>
          ...
          <div class="mb-3 row">
            <div class="col-md-6">
              ...
              <input type="districts" name="districts" class="form-control rad-6 fs-normal" value="{{ $tables->districts }}" placeholder="Districts">
              @error('districts')
                <div class="invalid-feedback ml-1">{{ $message }}</div>
              @enderror
            </div>
            <div class="col-md-6">
              ...
              <input type="text" name="ward" class="form-control rad-6 fs-normal" value="{{ $tables->ward }}" placeholder="Ward">
              @error('ward')
                <div class="invalid-feedback ml-1">{{ $message }}</div>
              @enderror
            </div>
