        ...
        <form action="/user/change_password" method="post" enctype="multipart/form-data">
          ...
          <div class="mb-3 row">
            <div class="col-md-6">
              ...
              <input type="email" readonly name="email" value="{{ $data->user->email }}" class="form-control rad-6 fs-normal" placeholder="Email">
            </div>
            <div class="col-md-6">
              <label for="name" class="fs-normal mb-1">Full Name : </label>
              <input type="text" readonly name="name" value="{{ $data->name }}" class="form-control rad-6 fs-normal" placeholder="Full Name">
            </div>
          </div>
